...
module ReflTests (a' a : A) where
 ...
 module _ (s : Square (refl {x = a}) (refl {x = a}) (refl {x = a}) (refl {x = a}))
        (c : Cube (λ _ _ → a) s (λ _ _ → a) (λ _ _ → a) (λ _ _ → a) (λ _ _ → a))
         where
  ...
  _ : --I → I → I → I → A
      ...
      --        a
      --        a)
      --        (((refl {x = a}) ∙ (refl {x = a}) ∙ (refl {x = a}) ∙ (refl {x = a})))
      --        (((((refl {x = a}) ∙ (refl {x = a})) ∙ (refl {x = a})) ∙ (refl {x = a}))))
      --        (assoc (refl {x = a}) (refl {x = a}) ((refl {x = a}) ∙ (refl {x = a})) ∙ assoc ((refl {x = a}) ∙ (refl {x = a})) (refl {x = a}) (refl {x = a}))
      --        (cong ((refl {x = a}) ∙_) (assoc (refl {x = a}) (refl {x = a}) (refl {x = a})) ∙∙ assoc (refl {x = a}) ((refl {x = a}) ∙ (refl {x = a}))
      --     (refl {x = a}) ∙∙ cong (_∙ (refl {x = a})) (assoc (refl {x = a}) (refl {x = a}) (refl {x = a}))))
      --   penta-refl (pentagonIdentity refl refl refl refl)
       penta-refl ≡ (pentagonIdentity refl refl refl refl)
  _ = solvePaths
...
--             (hcomp
--              (λ 𝒛₁ →
--                 primPOr (~ 𝒛 ∧ i1) _ (constPartial a (~ 𝒛 ∧ i1))
--                 (primPOr (𝒊₃ ∧ i1) _ (constPartial a (𝒊₃ ∧ i1))
--                  (primPOr (~ 𝒊₃ ∧ i1) _ (constPartial a (~ 𝒊₃ ∧ i1))
--                   (primPOr (𝒊₂ ∧ i1) _
--                    (constPartial
--                     (hcomp
...
--                                   (primPOr (𝒛₂ ∧ i1) _ (constPartial a (𝒛₂ ∧ i1))
--                                    (primPOr (𝒊₂ ∧ i1) _ (constPartial a (𝒊₂ ∧ i1))
--                                     (primPOr (~ 𝒛₂ ∧ ~ 𝒊₂ ∧ i1) _ (constPartial a (~ 𝒛₂ ∧ ~ 𝒊₂ ∧ i1))
--                                      (constPartial a (~ 𝒛₁ ∧ i1))))))
--                                a))
--                              (𝒊₃ ∧ i1))
--                             (primPOr (~ 𝒊₃ ∧ i1) _ (constPartial a (~ 𝒊₃ ∧ i1))
...
--                                       (λ 𝒛₄ →
--                                          primPOr (~ 𝒛 ∧ i1) _ (constPartial a (~ 𝒛 ∧ i1))
--                                          (primPOr (𝒛₃ ∧ 𝒛₂ ∧ i1) _ (constPartial a (𝒛₃ ∧ 𝒛₂ ∧ i1))
--                                           (primPOr (~ 𝒛₂ ∧ i1) _ (constPartial a (~ 𝒛₂ ∧ i1))
--                                            (primPOr (~ 𝒛₃ ∧ i1) _ (constPartial a (~ 𝒛₃ ∧ i1))
--                                             (constPartial a (~ 𝒛₁ ∧ i1))))))
--                                       a)
...
--                                        (hcomp
--                                         (λ 𝒛₄ →                              --here
--                                            primPOr (~ 𝒛 ∧ i1) _ (constPartial (c 𝒛₄ 𝒛₃ 𝒊₃)  (~ 𝒛 ∧ i1))
--                                            (primPOr (~ 𝒊₃ ∧ i1) _ (constPartial a (~ 𝒊₃ ∧ i1))
--                                             (constPartial a (𝒊₃ ∧ i1))))
--                                         a)
--                                        (𝒛₂ ∧ ~ 𝒛₁ ∧ i1))
