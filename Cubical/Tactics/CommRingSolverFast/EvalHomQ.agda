module Cubical.Tactics.CommRingSolverFast.EvalHomQ where
...
open import Cubical.Algebra.CommRing.Instances.Rationals.Fast as ℚ
...
module HomomorphismProperties  where
  ...
  open IsCommRingHom (snd homFromℚ)
