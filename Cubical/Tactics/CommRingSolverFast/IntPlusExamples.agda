{-# OPTIONS --verbose ratSolver:20 --verbose  intSolver:20 --verbose  intSolverVars:20 --verbose  intSolverGoal:20  #-}
...
testFromBisect : ∀ k m  k₁ m₁ k₂ m₂
      k₃ m₃ k₄ m₄ k₅ m₅ →
       ((pos (suc k) ℤ.·
            ...
            (pos (suc k₁) ℤ.·
             (k₂ ℤ.· ℕ₊₁→ℤ ((1+ 0) ·₊₁ (1+ m₃)) ℤ.+
              ℤ.negsuc 0 ℤ.· k₃ ℤ.· ℕ₊₁→ℤ (1+ m₂))
             ℤ.· ℕ₊₁→ℤ ((1+ 0) ·₊₁ ((1+ m₄) ·₊₁ ((1+ 0) ·₊₁ (1+ m₅))))
             ℤ.+
             ℤ.negsuc 0 ℤ.·
             (k₄ ℤ.· ℕ₊₁→ℤ ((1+ 0) ·₊₁ (1+ m₅)) ℤ.+
              ℤ.negsuc 0 ℤ.· k₅ ℤ.· ℕ₊₁→ℤ (1+ m₄))
             ℤ.· ℕ₊₁→ℤ ((1+ m₁) ·₊₁ ((1+ m₂) ·₊₁ ((1+ 0) ·₊₁ (1+ m₃)))))
            ℤ.· ℕ₊₁→ℤ (1+ m)
            ,
            (1+ m) ·₊₁
            ((1+ m₁) ·₊₁ ((1+ m₂) ·₊₁ ((1+ 0) ·₊₁ (1+ m₃))) ·₊₁
...
testFromBisect k m k₁ m₁ k₂ m₂ k₃ m₃ k₄ m₄ k₅ m₅ = {!ℤ!!}
