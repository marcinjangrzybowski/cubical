module Cubical.Tactics.CommRingSolverFast.HornerFormsQ where

open import Cubical.Foundations.Prelude

open import Cubical.Data.Nat using (ℕ)
open import Cubical.Data.Fast.Int hiding (_+_ ; _·_ ; -_)
...
open import Cubical.Tactics.CommRingSolverFast.AlgebraExpression public
...
data IteratedHornerForms (A : RawAlgebra ℚAsRawRing ℓ) : ℕ → Type ℓ where
  const : ℚ.ℚ → IteratedHornerForms A ℕ.zero
...
-}
module _ (A : RawAlgebra ℚAsRawRing ℓ) where
...
module IteratedHornerOperations (A : RawAlgebra ℚAsRawRing ℓ) where
  open RawRing ℤAsRawRing
...
Variable : (n : ℕ) (R : RawAlgebra ℚAsRawRing ℓ') (k : Fin n) → IteratedHornerForms R n
Variable n R k = IteratedHornerOperations.X R n k

Constant : (n : ℕ) (R : RawAlgebra ℚAsRawRing ℓ') (r : ℤ) → IteratedHornerForms R n
