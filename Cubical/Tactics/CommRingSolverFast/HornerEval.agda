module Cubical.Tactics.CommRingSolverFast.HornerEval where

open import Cubical.Foundations.Prelude

open import Cubical.Data.Nat using (ℕ)
open import Cubical.Data.Fast.Int hiding (_+_ ; _·_ ; -_;+IdR;+IdL)
...
module HRE (R : CommRing ℓ) (homFromℤ@(scalar , _) : CommRingHom ℤCommRing R) where
  private
  ...
  evalIsZero : {n : ℕ} (P : IteratedHornerForms νR n)
             ...
             → isZero νR P ≡ true
             → eval P l ≡ 0r
  evalIsZero (const (pos ℕ.zero)) [] isZeroP = pres0
