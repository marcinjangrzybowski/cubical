...
-- runIdentity ((RawApplicativeIdentityM RawApplicative.<$> f) x) = f (runIdentity x)
-- runIdentity (RawApplicative.pure RawApplicativeIdentityM x) = x
-- runIdentity ((RawApplicativeIdentityM RawApplicative.<*> f) x) = runIdentity f (runIdentity x)
