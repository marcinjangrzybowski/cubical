...
ℕ≥→negsuc-≤-negsuc m n p = negsuc≤negsuc (ℕ.≤→≤ᵗ p)

pos-≤-pos→ℕ≤ : ∀ m n → pos m ≤ pos n → m ℕ.≤ n
pos-≤-pos→ℕ≤ m n (pos≤pos x) = ℕ.≤ᵗ→≤ x
...
0<·ℕ₊₁ (pos (suc m)) n (pos<pos x) = pos<pos tt
0<·ℕ₊₁ (negsuc n₁) (1+ n) ()

·0< : ∀ m n → 0 < m → 0 < n → 0 < (m ℤ.· n)
·0< (pos (suc m)) (pos (suc n)) (pos<pos _) (pos<pos _) = pos<pos _
