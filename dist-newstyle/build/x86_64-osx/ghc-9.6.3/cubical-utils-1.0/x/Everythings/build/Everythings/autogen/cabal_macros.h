...
/* package cubical-utils-1.0 */
#ifndef VERSION_cubical_utils
#define VERSION_cubical_utils "1.0"
#endif /* VERSION_cubical_utils */
#ifndef MIN_VERSION_cubical_utils
#define MIN_VERSION_cubical_utils(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_cubical_utils */
...
#define CURRENT_COMPONENT_ID "cubical-utils-1.0-inplace-Everythings"
